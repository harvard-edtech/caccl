...
> 
> Remember to add both the installationCredentials and developerCredentials (see [Adding Your App to Canvas](#adding-your-app-to-canvas)).
> 
> If you want to save space, you can leave out everything in the `/client` folder _except_ the `/client/build` folder.
